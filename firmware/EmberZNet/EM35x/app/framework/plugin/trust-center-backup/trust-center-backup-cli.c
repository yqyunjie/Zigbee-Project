// *****************************************************************************
// * trust-center-backup-cli.c
// *
// * User interface for backing up and restoring a trust center.
// *
...
static void printExportDataCommand(void);
static void printImportDataCommand(void);
static void setExtendedPanIdCommand(void);
static void restoreFromBackupCommand(void);
static void importKeyCommand(void);
static void importClearCommand(void);
...
#if defined(EMBER_AF_PRINT_SECURITY) || defined(EMBER_TEST)
...
static void printBackup(const EmberAfTrustCenterBackupData* backup)
{
  int8u i = 0;
...
static void importKeyCommand(void)
{
  ...
  MEMCOPY(importKeyList[index].deviceId, partnerEUI64, EUI64_SIZE);
  MEMCOPY(emberKeyContents(&(importKeyList[index].key)),
...
static void setExtendedPanIdCommand(void)
{
  emberAfCopyBigEndianEui64Argument(0, importData.extendedPanId);
}
...
#endif // #if defined(EMBER_AF_PRINT_SECURITY) || defined(EMBER_TEST)
