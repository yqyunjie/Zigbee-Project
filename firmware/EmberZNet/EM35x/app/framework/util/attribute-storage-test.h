// *******************************************************************
// * attribute-storage-test.h
// *
// * Attribute storage configuration for unit test
// *
...
#define GENERATED_ATTRIBUTES   {                         \
    { 101, 1, 1, 0, { (int8u*)(generatedDefaults+0) } }, \
    { 102, 1, 2, 0, { (int8u*)1 } },                     \
    { 103, 1, 3, 0, { (int8u*)1 } },                     \
    { 104, 1, 4, 0, { (int8u*)1 } },                     \
    { 105, 1, 5, 0, { (int8u*)1 } }                      \
...
// These are the EmberAfNetwork structs that the application supports.
// Each endpoint belongs to one of these networks.
...
#define endpointType(index)   ((EmberAfEndpointType*)&(generatedEmberAfEndpointTypes[0]))
