...
////////////////////////////////////////////////////////////////////////////////
   ...
   */
  void halCommonMemCopy(void *dest, const void *src, int16u bytes);
   ...
   * parameter.
   */
  int8s halCommonMemPGMCompare(const void *source0, const void PGM_NO_CONST *source1, int16u bytes);

  /**
   * @brief Same as the C stdlib memcpy(), but handles copying from const 
   * program space.
   */
  void halCommonMemPGMCopy(void* dest, const void PGM_NO_CONST *source, int16u bytes);
