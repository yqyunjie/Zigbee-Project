...
{
  int32u ember, customer = 0xFFFFFFFF;
  ...
  if(halBootloaderAddressTable.baseTable.version >= 0x0109) {
    ...
    ember = ((int32u)halBootloaderAddressTable.bootloaderVersion)<<16 | halBootloaderAddressTable.bootloaderBuild;
    ...
    ember  = (((int32u)halBootloaderAddressTable.bootloaderVersion)<<16) & 0xFF000000;
