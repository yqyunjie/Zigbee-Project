 ...
 *
 * <!-- Copyright 2008-2013 by Silicon Laboratories. All rights reserved.*80*-->
 */
 ...
 *      `- RHO (RADIO_HOLDOFF)                   IN_PUDv  IN_PUDv (WAKE_ON)
...
/**
 * @brief This define does not equate to anything.  It is used as a
 * trigger to disable bias adjustment of the 24 MHz crystal oscillator.
 ...
 * break the link!).
 */
#define EZSP_PIN_BLACKOUT_MASK  ((1<<PORTA_PIN(0))|  /*HOST_MOSI */ \
                                 (1<<PORTA_PIN(1))|  /*HOST_MISO */ \
                                 (1<<PORTA_PIN(2))|  /*HOST_SCLK */ \
                                 (1<<PORTA_PIN(3))|  /*HOST_nSEL */ \
                                 (1<<PORTB_PIN(2))|  /*HOST_nINT */ \
                                 (1<<PORTB_PIN(4))|  /*HOST_nINT'*/ \
                                 (1<<PORTB_PIN(6)))  /*HOST_nWAKE*/
