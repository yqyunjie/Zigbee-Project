...
typedef int8u tokTypeMfgEmberEui64[8];
typedef struct {
  int16u iffilterL;
  int16u lna;
  int16u ifamp;
...
typedef int16u tokTypeMfgOsc24mSettleDelay;
typedef int16u tokTypeMfgSecurityConfig;
typedef int16u tokTypeMfgCcaThreshold;
typedef struct {
	int8u data[16];  // AES-128 key
...
// reserved for future stack use         0x0908 - 0x0FFF // 1783 bytes free
//--- Virtual MFG Tokens ---             
