...
extern int16u emMaximumIncomingTransferSize;
extern int16u emMaximumOutgoingTransferSize;
extern int8u emDescriptorCapability;
...
extern int8u emDefaultSecurityLevel;
...
int8u emberSecurityLevel(void);
// New function (defined in ember-stack-common.c)
void emberSetSecurityLevel(int8u securityLevel);
#endif
