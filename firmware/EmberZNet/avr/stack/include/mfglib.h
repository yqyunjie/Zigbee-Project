 ...
 * 
 * In addition, there is a sample application that demonstrates 
 * the use of this library in app/util/mfgcli/mvglibcli.c.
 *
 ...
 * These packets will not be passed up with a CRCfailure.  
 * The first byte of the packet in the callback is the length.
 * All other functions will return an error until the
