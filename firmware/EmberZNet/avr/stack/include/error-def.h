...
#ifdef DOXYGEN_SHOULD_SKIP_THIS
/** 
 * @brief An unknown flash token was specified.
 */
#define EMBER_ERR_TOKEN_UNKNOWN(0x4B)
#else
DEFINE_ERROR(ERR_TOKEN_UNKNOWN, 0x4B)
#endif //DOXYGEN_SHOULD_SKIP_THIS


#ifdef DOXYGEN_SHOULD_SKIP_THIS
/** 
 * @brief Could not create a new flash token because it already exists.
 */
#define EMBER_ERR_TOKEN_EXISTS(0x4C)
#else
DEFINE_ERROR(ERR_TOKEN_EXISTS, 0x4C)
#endif //DOXYGEN_SHOULD_SKIP_THIS


#ifdef DOXYGEN_SHOULD_SKIP_THIS
/** 
 * @brief An incorrect size was specified when retrieving token data.
 */
#define EMBER_ERR_TOKEN_INVALID_SIZE(0x4D)
#else
DEFINE_ERROR(ERR_TOKEN_INVALID_SIZE, 0x4D)
#endif //DOXYGEN_SHOULD_SKIP_THIS


#ifdef DOXYGEN_SHOULD_SKIP_THIS
/** 
 * @brief Could not write the token because it is marked read-only.
 */
#define EMBER_ERR_TOKEN_READ_ONLY(0x4E)
#else
DEFINE_ERROR(ERR_TOKEN_READ_ONLY, 0x4E)
#endif //DOXYGEN_SHOULD_SKIP_THIS
 ...
 * hardware radio type.
 */
#define EMBER_PHY_UNKNOWN_RADIO_TYPE(0x8D)
#else
DEFINE_ERROR(PHY_UNKNOWN_RADIO_TYPE, 0x8D)
#endif //DOXYGEN_SHOULD_SKIP_THIS
...
#ifdef DOXYGEN_SHOULD_SKIP_THIS
/**
 * @brief The PHY did not receive the entire packet it was expecting
 * from the radio.
 */
#define EMBER_PHY_PARTIAL_PACKET(0x8F)
#else
DEFINE_ERROR(PHY_PARTIAL_PACKET, 0x8F)
#endif //DOXYGEN_SHOULD_SKIP_THIS
