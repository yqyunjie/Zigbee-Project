...
/** @brief If there is a child at 'index' this copies its EUI64 and
  ...
  *
  * @param childEui64Return The child's EUI64 is copied into here.
  *
  * @param childTypeReturn  The child's node type is copied into here.
  *
...
extern int8u emMaxEndDeviceChildren;    // maximum for this node
extern int8u emEndDeviceChildCount;     // how many we have
extern EmberNodeId emParentId;
extern EmberEUI64 emParentEui64;
...
#define emberGetParentEui64()      (emParentEui64       + 0)
...
enum
{
   ...
   /** The node is currently trying to associate with a network. */
...
/** @brief Turns the radio power on.
 */
