 ...
 *
 * @param port  The serial port to use.  Pass BOOTLOAD_DEBUG_PORT to use
 * ezspSerialWrite(). 0 for Mega32 port. 0 or 1 for Linux ports.
 *  
 ...
 *
 * Output to local ports or via ezspSerialWrite().
 *
 * @param port  The serial port to use.  Pass BOOTLOAD_DEBUG_PORT to use
 * ezspSerialWrite(). 0 for Mega32 port. 0 or 1 for Linux ports.
 *  
