...
#ifndef EZSP_HOST_ASH_RX_POOL_SIZE
/** @brief Define the size of the ASH receive buffer pool on the EZSP host.
 *
 ...
 */
  #define EZSP_HOST_ASH_RX_POOL_SIZE 20
#endif

#ifndef EZSP_HOST_FORM_AND_JOIN_BUFFER_SIZE
/** @brief The size of the buffer for caching data during scans.
 *
 * The form and join host library uses a flat buffer to store
 * channel energy, pan ids, and matching networks.  The minimum
 * required size is 32 bytes.  A matching network requires 14
 * bytes so a multiple of 14 is most efficient.
 */
  #define EZSP_HOST_FORM_AND_JOIN_BUFFER_SIZE 70
#endif
