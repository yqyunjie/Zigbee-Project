...
/** @brief Initializes the symbol timer.
  */
...
/** @brief Returns the time (as returned by
 * halStackGetInt32uSymbolTick()) of the  most recent SFD (Start Frame
 * Delimiter) detected by the radio.
 *
 * @return The time of the most recent SFD detected by the radio. 
 * @note  Returns 0 if no SFD has been detected by the radio.
 */
