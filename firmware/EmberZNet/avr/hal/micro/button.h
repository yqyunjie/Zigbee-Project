 ...
 *
 * @note this is correlated with ::halButtonIsr() and so returns the "soft"
 * state rather than reading the actual state of the pin.
 *   
 ...
 *
 * This reads the actual state of the pin
 * and can be used on startup to determine the initial position of the
 * buttons.
 *   
 * @param button  The button being queried.
 *
 * @return  ::BUTTON_PRESSED if the button is pressed or ::BUTTON_RELEASED 
 * if the button is not pressed.
 */
 ...
 * changes its state.
 * 
 * @appusage Must be implemented by the application.  Will typically contain the
 * functionality to be executed in response to changes of state in each of the
 * buttons, or callbacks to this functionality.
 *  
