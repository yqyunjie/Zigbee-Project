/** @file dev0222.h 
 *  @brief Functions specific to the BOARD_DEV0222 carrier board.
 *
 *  See also @ref board.
 *
 *  This carrier board supports packet trace.
 *
 *  Reminder: The term SFD refers to the Start Frame Delimiter.
 * 
 * <!-- Author(s): DC Seward (dc@ember.com) -->
...
#define PACKET_TRACE_CS_PORT     PORTB
#define PACKET_TRACE_CS_PIN      PINB
#define PACKET_TRACE_CS_DDR      DDRB
#define PACKET_TRACE_CS          4

#define PACKET_TRACE_FRAME_PORT  PORTE
#define PACKET_TRACE_FRAME_PIN   PINE
#define PACKET_TRACE_FRAME_DDR   DDRE
#define PACKET_TRACE_FRAME       6

#define PACKET_TRACE_DIR_PORT    PORTE
#define PACKET_TRACE_DIR_PIN     PINE
#define PACKET_TRACE_DIR_DDR     DDRE
#define PACKET_TRACE_DIR         3
 ...
 */
//@{
#define DEBUGSYNC_TRIGGER_PORT  PORTB
#define DEBUGSYNC_TRIGGER_PIN   PINB
#define DEBUGSYNC_TRIGGER_DDR   DDRB
#define DEBUGSYNC_TRIGGER       6
 ...
 * provide the abstraction.
 *
 * The BOARDLED<i>n</i> enum values should always be used when manipulating the 
 ...
 * Note: (2) LEDs 2, 3, 4, and 5 are on the carrier board (DEV0222).
 */
//@{
