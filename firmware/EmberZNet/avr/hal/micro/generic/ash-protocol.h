...
#define ASH_VERSION 0x02      // protocol version
...
/**  byte substituted for bytes received with framing, overrun or overflow errors */
#define ASH_SUB   0x18        
...
// Define macros for handling 3-bit frame numbers module 8
