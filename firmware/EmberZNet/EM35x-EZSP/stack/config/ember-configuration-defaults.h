 ...
 */
#if !defined(EMBER_ZLL_STACK) && (EMBER_STACK_PROFILE == 2) && !defined(EMBER_TEST)
  #if defined(EMBER_BROADCAST_TABLE_SIZE)
    #error "Cannot override broadcast table size unless (EMBER_STACK_PROFILE != 2) or EMBER_ZLL_STACK"
  #endif
#endif
 ...
 *  processor idling.  The EmberZNet stack requires 1, an application and 
 ...
 */
#define EMBER_MAX_SUPPORTED_NETWORKS 4
