 ...
 *     - hal/host/cortexm3/stm32f103ret/adc.c
 *
 ...
 *     - hal/host/cortexm3/stm32f103ret/buzzer.c
 *
...
void halInit(void)
{
  ...
  int32u apb1Peripherals = (RCC_APB1Periph_BKP  |
                            RCC_APB1Periph_PWR  |
                            RCC_APB1Periph_SPI2 |
                            RCC_APB1Periph_TIM2 |
                            RCC_APB1Periph_TIM3 |
                            RCC_APB1Periph_TIM5 );
  int32u apb2Peripherals = (RCC_APB2Periph_ADC1   |
                            RCC_APB2Periph_AFIO   |
...
void halCommonDelayMicroseconds(int16u us)
{
  ...
  SysTick->LOAD = (72-1);
  SysTick->VAL = 0;
  (int32u)SysTick->CTRL; //ensure COUNTFLAG is cleared
