...
//@{
     ...
     */
    #define DECLARE_INTERRUPT_STATE int32u _emIsrState
 ...
 * the full C Standard Library as supplied by IAR.
 */
#include <string.h>
#define halCommonMemSet(d,v,l) memset(d,v,l)
#define halCommonMemCopy(d,s,l) memmove(d,s,l)
#define halCommonMemCompare(s0,s1,l) memcmp(s0, s1, l)
#define halCommonMemPGMCompare(s0,s1,l) memcmp(s0, s1, l)
#define halCommonMemPGMCopy(d,s,l) memcpy(d,s,l)
