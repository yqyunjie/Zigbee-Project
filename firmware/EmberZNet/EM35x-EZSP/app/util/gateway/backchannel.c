...
#define SERVER_PORT_OFFSET_DEFAULT 4900

int backchannelSerialPortOffset = SERVER_PORT_OFFSET_DEFAULT;
...
EmberStatus backchannelClientConnectionCleanup(int8u port)
{
  if (!backchannelEnable) {
    return EMBER_INVALID_CALL;
  }
