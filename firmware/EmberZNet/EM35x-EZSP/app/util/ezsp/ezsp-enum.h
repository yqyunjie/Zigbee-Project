...
#define EZSP_CONFIG_ID_MAX  0x30
...
typedef int8u EzspExtendedValueId;
...
#define EZSP_EXTENDED_VALUE_ID_MAX  0x01

//------------------------------------------------------------------------------
// Flags associated with the endpoint data configured on the NCP.
typedef int16u EzspEndpointFlags;
...
#define EZSP_POLICY_ID_MAX  0x07
...
#define EZSP_MFG_TOKEN_ID_MAX  0x0B
...
typedef int8u EzspZllNetworkOperation;
