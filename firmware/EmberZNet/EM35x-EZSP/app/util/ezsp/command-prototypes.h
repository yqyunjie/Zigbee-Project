...
// Similar to ezspNetworkInit(). Resume network operation after a reboot. This
// command is different in that it accepts options to control the network
// initialization.
// Return: An EmberStatus value that indicates one of the following: successful
// initialization, EMBER_NOT_JOINED if the node is not part of a network, or the
// reason for failure.
...
EmberStatus ezspSetConcentrator(
      // If this boolean is TRUE the concentrator support is enabled. Otherwise
      // is disabled. If this boolean is FALSE all the other arguments are
      // ignored.
      boolean on,
